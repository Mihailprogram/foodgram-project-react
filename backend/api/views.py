...
from recipes.models import (FavoriteRecipe, Ingredient, Recept, ShoppingCart,
                            Subscribe, Tag)
...
class GetObjectMixin:
    ...
    def get_object(self):
        ...
        recipe = get_object_or_404(Recept, id=recipe_id)
...
class RecipesViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Recept.objects.annotate(
            is_favorited=Exists(
        ...
        ) if self.request.user.is_authenticated else Recept.objects.annotate(
